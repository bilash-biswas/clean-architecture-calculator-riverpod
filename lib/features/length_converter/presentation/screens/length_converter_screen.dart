...
import '../notifiers/length_converter_notifier.dart';
...
class LengthConverterScreen extends ConsumerWidget {
              ...
              children: [
                  ...
                  child: Material(
                    ...
                    child: Container(
                      ...
                      child: IconButton(
                        ...
                        iconSize: 28,
                        onPressed: () => ref.read(lengthConverterProvider.notifier).swapUnits(),
                      ),
                    ),
                  ),
                ),
                ...
                Container(
                  ...
                  child: TextButton.icon(
                    onPressed: () {
                      ref.read(lengthConverterProvider.notifier).saveToHistory();
  ...
  Widget _buildUnitPanel({
    ...
    final theme = Theme.of(context);
    final isDark = theme.brightness == Brightness.dark;
    final unit = LengthUnit.fromAbbreviation(unitAbbr);
    ...
    return ClipRRect(
      ...
      child: BackdropFilter(
        ...
        child: InkWell(
          onTap: () => ref.read(lengthConverterProvider.notifier).selectTab(isFrom),
          borderRadius: BorderRadius.circular(24),
  ...
  Widget _buildKeypadButton(
    ...
    final theme = Theme.of(context);
    final isDark = theme.brightness == Brightness.dark;
    final notifier = ref.read(lengthConverterProvider.notifier);
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return ListTile(
                          ...
                          onTap: () {
                            if (isFrom) {
                              ref.read(lengthConverterProvider.notifier).setFromUnit(unit.abbreviation);
                            } else {
                              ref.read(lengthConverterProvider.notifier).setToUnit(unit.abbreviation);
                            }
...
class _LengthKeypadButton extends StatefulWidget {
  final String text;
  ...
  @override
  State<_LengthKeypadButton> createState() => _LengthKeypadButtonState();
}

class _LengthKeypadButtonState extends State<_LengthKeypadButton> with SingleTickerProviderStateMixin {
